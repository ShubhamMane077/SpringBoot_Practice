...
public class PatientResponseDto {
    ...
    private Doctor doctor; // Add this field for the list of doctors

    public PatientResponseDto() {
    }

    public PatientResponseDto(int patientId, String firstName, String lastName, String gender, LocalDate dateOfBirth,
            ...
            String maritalStatus, String nationality, String language_spoken, String religion, Doctor doctor) {
        super();
